    ...
    return(
      ...
      <div className='bg-white h-[400px] w-[85%] flex flex-col justify-center items-center rounded-[0.9rem] md:h-[450px] md:w-[50%] lg:w-[39%] lg:h-[490px] lg:rounded-[1.5rem]'>
        ...
        <div className='mt-2 text-center md:mt-4'>
          <p className='md:text-[1.2rem]'>Didn’t get the code? <a href="#" className='text-[#ba8136] underline underline-offset-4' onClick={handleResend} >Click to resend</a></p>
        </div>
        <div className='text-center mt-8 flex flex-row w-[80%] justify-center'>
          <button onClick={handleCancel} className='w-28 h-8 mr-8 text-center text-[#ba8136] border-2 border-[#ba8136] rounded-[0.2rem]' >Cancel</button>
          <button onClick={handleVerify} className='w-28 h-8 mb-4 text-center text-white bg-[#ba8136] border-2 border-[#3664AF] rounded-[0.2rem]' >Verify</button>
        </div>
      </div>
    </div>
    )
