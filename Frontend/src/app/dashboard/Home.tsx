    ...
    return(
        <div className="w-full mt-10 lg:mt-0" >
                ...
                <div className="grid  max-w-[600px] text-white xl:grid-cols-[1.2fr_1fr] xl:grid-rows-[1fr_0.5fr_1fr] grid-cols-1 grid-rows-[1fr_1fr_1fr_1fr_1fr] 2xl:mx-auto xl:mx-10 mx-auto h-[calc(100%-100px)] xl:max-w-[1200px] lg:min-w-[600px] ">
                    {/* 1st block */}
                    <div className="bg-[#ba8136] xl:mr-10 mb-10 rounded-[20px] h-[232px] sm:h-[320px] pb-7 ">
                        ...
                        <ul className="flex flex-col list-inside list-disc">
                            {updates.map((updates, key)=>(
                                <li key={key} className={key%2==0?'bg-yellow-600 sm:py-4 py-1 px-5 sm:px-10 h-[7rem]':'h-[7rem] px-5 py-1 sm:py-4 sm:px-10'}>{updates.text}</li>
                            )
                            )}
                        </ul>
                    ...
                    {/* 2nd block */}
                    <div className="bg-[#ba8136] mb-10 rounded-[20px] sm:p-7 sm:px-7 px-4 pb-2 pt-0 sm:pt-0">
                    ...
                    {/* third block */}
                    <div className="bg-[#ba8136] xl:mr-10 mb-10 rounded-[20px] sm:p-7 sm:px-7 px-4 pb-2 pt-0 sm:pt-0">
                    ...
                    {/* 5th block */}
                    <div className="bg-[#ba8136]  mb-10 rounded-[20px] xl:col-span-2 lg:p-6 p-5  ">
