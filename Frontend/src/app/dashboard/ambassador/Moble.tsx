...
export default function Mobile(){
    ...
    return(
        <div className="m-5 p-5 bg-[#ba8136] space-y-10 flex rounded-[20px] py-10 flex-col items-center justify-center">
            <h1 className="font-semibold text-[20px] leading-[14px] tracking-[0.31px] text-white rmd:text-[18px]">School Ambassador Programme</h1>
            ...
            <div className="w-[301px] h-[64px] rounded-[12px] bg-white text-center flex items-center justify-center">
                <h1 className="font-bold text-[32px] leading-normal text-[#ba8136] text-center">{user.myReferral}</h1>
            </div>
            <div className="bg-[#ba8136] rounded-[20px]  border-[5px] h-[276px] w-[318px] p-5">
                    ...
                    <div className="text-[14px] tracking-[0.5px] leading-[24px] text-center text-white flex flex-col gap-5">
                        ...
                        <h1>At 2000 referrals you will get a chance to visit IIT Roorkee </h1>
                    </div>
            </div>
