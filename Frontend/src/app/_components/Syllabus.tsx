...
function NavButton({text}:any){
    return (
        ...
        <button id={`b${text}`}  className="transition ease-out duration-300 border-4 border-[#FFE016] rounded-full xl:w-[261px] w-[20vw] text-[20px] leading-[25px] text-[#FAF4BE] font-bold h-[60px] cursor-pointer hover:bg-[#A96104] hover:border-[#FFE016] active:bg-[#BA8136] active:border-[#FFE645]">{text}</button>
