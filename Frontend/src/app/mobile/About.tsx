        ...
        <div className="relative h-[900px] w-full bg-[#E5F2FF] flex flex-col m-0 pr-0 justify-between">
            ...
            <div className="mt-[00px] ml-6 w-[65%] relative left-[20px] top-[40px] ">
                ...
                <p className="sm:text-[20px] text-[15px] leading-[24px] text-justify">
                    ...
                    designed by our student community, all within the exciting and adventurous theme of Harry Potter. 
                    Organized by the Outreach Cell of IIT Roorkee, this year marks the fourth edition of GambitoR, promising to bring 
