          ...
          <div className="w-full max-w-md px-8 py-10">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full py-3 text-sm font-medium tracking-wide text-white bg-yellow-600 rounded-lg hover:bg-yellow-500 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-opacity-50"
              >
                Log In
              </button>
            </div>
            ...
            <div className="mt-6 text-center">
              <a href="/signup" className="text-xs text-gray-500 no-underline">
                ...
                <span className="text-yellow-600 px-2 py-1 rounded">Create an account</span>
              </a>
            </div>
          </div>
        </div>
