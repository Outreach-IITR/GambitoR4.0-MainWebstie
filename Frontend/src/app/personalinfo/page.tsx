    ...
    <div className="min-h-screen flex rmd:flex-col-reverse text-black bg-[#FAFAFA]">
      <div className="bg-white w-1/4 rmd:w-full flex flex-col p-8 rmd:p-4 items-center">
        <div className="flex flex-col rmd:flex-row rmd:justify-between justify-center pt-72 rmd:pt-0">
          ...
          <p className="text-[#ba8136] font-bold flex flex-row">
            <span className="bg-[#ba8136] text-white w-6 h-6 rounded-full text-center mr-2">2</span>{" "}
            Personal Info
          </p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="rmd:px-2 rmd:py-5">
            ...
            <label
              ...
              className="block text-black text-sm mb-1 transition-colors duration-200 ease-in-out peer-focus:text-[#ba8136]"
            >
              Profile Photo (optional)
            </label>
            <div className="relative flex items-center px-3 py-2 border bg-white border-gray-300 focues:border-[#ba8136] cursor-pointer">
              ...
              <div className="flex justify-between mb-6 mt-16">
                ...
                <button
                  type="submit"
                  className="px-8 py-2 rmd:w-2/5 bg-[#ba8136] text-white rounded"
                >
                  Done
                </button>
              </div>
              <div className="text-gray-600 flex justify-end">
                ...
                <a href="https://chat.whatsapp.com/FrpleRIKfO1AYEXJ807MDL" className="text-[#ba8136]">
                  Get help
                </a>
              </div>
            </form>
